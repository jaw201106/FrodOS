// shell_simple.c - Simplified working shell
#include "shell.h"
#include "fs.h"
#include "io.h"
#include "snake.h"
...
void process_command(char* buffer, int* cursor) {
    ...
    *cursor = (*cursor / 80 + 1) * 80;
    ...
    else if(str_compare(buffer, "ls") == 0) {
        *cursor = (*cursor / 80 + 1) * 80;
    ...
    else if(str_compare(buffer, "snake") == 0) {
        start_snake_game();
    }
    else if(str_compare(buffer, "oregon") == 0) {
        start_oregon_trail();
    }
